...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	...
	<table class="ms-core-tableNoSpace" id="onetIDListForm">
	 ...
	 <WebPartPages:WebPartZone runat="server" FrameType="None" ID="Main" Title="loc:Main"><ZoneTemplate>
		<WebPartPages:DataFormWebPart runat="server" EnableOriginalValue="False" DisplayName="KeyContacts" ViewFlag="1048584" ViewContentTypeId="" Default="FALSE" ListUrl="" ListDisplayName="" ListName="{79622431-CF27-4382-9B92-43A19CD55EA2}" ListId="79622431-cf27-4382-9b92-43a19cd55ea2" PageType="PAGE_NEWFORM" PageSize="-1" UseSQLDataSourcePaging="True" DataSourceID="" ShowWithSampleData="False" AsyncRefresh="False" ManualRefresh="False" AutoRefresh="False" AutoRefreshInterval="60" NoDefaultStyle="TRUE" InitialAsyncDataFetch="False" Title="KeyContacts" FrameType="None" SuppressWebPartChrome="False" Description="" IsIncluded="True" PartOrder="2" FrameState="Normal" AllowRemove="True" AllowZoneChange="True" AllowMinimize="True" AllowConnect="True" AllowEdit="True" AllowHide="True" IsVisible="True" DetailLink="" HelpLink="" HelpMode="Modeless" Dir="Default" PartImageSmall="" MissingAssembly="Cannot import this Web Part." PartImageLarge="" IsIncludedFilter="" ExportControlledProperties="True" ConnectionID="00000000-0000-0000-0000-000000000000" ID="g_3cc63312_3a9c_47fb_83d1_21d01082a3bd" ChromeType="None" ExportMode="All" __MarkupType="vsattributemarkup" __WebPartId="{3CC63312-3A9C-47FB-83D1-21D01082A3BD}" __AllowXSLTEditing="true" WebPart="true" Height="" Width=""><DataSources>
				...
				<table border="0" cellspacing="0" width="100%">
					<tr>
						...
						<td width="400px" valign="top" class="ms-formbody">
							<div id="tabName">
								<SharePoint:FormField runat="server" id="FormField1" ControlMode="New" FieldName="Header" __designer:bind="{ddwrt:DataBind('i',concat('ff1',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Header')}"/>
							</div>
							<SharePoint:FieldDescription runat="server" id="FieldDescription1" FieldName="Header" ControlMode="New"/>
						</td>
					</tr>
					<tr id="section" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField2" ControlMode="New" FieldName="Section" __designer:bind="{ddwrt:DataBind('i',concat('ff2',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Section')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription2" FieldName="Section" ControlMode="New"/>
						</td>
					</tr>
					<tr id="area" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField3" ControlMode="New" FieldName="Area" __designer:bind="{ddwrt:DataBind('i',concat('ff3',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Area')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription3" FieldName="Area" ControlMode="New"/>
						</td>
					</tr>
					<tr id="office" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField4" ControlMode="New" FieldName="Office" __designer:bind="{ddwrt:DataBind('i',concat('ff4',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Office')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription4" FieldName="Office" ControlMode="New"/>
						</td>
					</tr>
					<tr id="specialty" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField5" ControlMode="New" FieldName="Specialty" __designer:bind="{ddwrt:DataBind('i',concat('ff5',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Specialty')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription5" FieldName="Specialty" ControlMode="New"/>
						</td>
					</tr>
					<tr id="group" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField6" ControlMode="New" FieldName="Group" __designer:bind="{ddwrt:DataBind('i',concat('ff6',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Group')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription6" FieldName="Group" ControlMode="New"/>
						</td>
					</tr>
					...
					<tr id="department" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField8" ControlMode="New" FieldName="Department" __designer:bind="{ddwrt:DataBind('i',concat('ff8',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Department')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription8" FieldName="Department" ControlMode="New"/>
						</td>
					</tr>
					<tr id="contact" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField9" ControlMode="New" FieldName="Contact" __designer:bind="{ddwrt:DataBind('i',concat('ff9',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Contact')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription9" FieldName="Contact" ControlMode="New"/>
						</td>
					</tr>
					<tr id="jobtitle" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField10" ControlMode="New" FieldName="Job_x0020_Title" __designer:bind="{ddwrt:DataBind('i',concat('ff10',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Job_x0020_Title')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription10" FieldName="Job_x0020_Title" ControlMode="New"/>
						</td>
					</tr>
					<tr id="phone" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField11" ControlMode="New" FieldName="Phone" __designer:bind="{ddwrt:DataBind('i',concat('ff11',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Phone')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription11" FieldName="Phone" ControlMode="New"/>
						</td>
					</tr>
					<tr id="mobile" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField12" ControlMode="New" FieldName="Mobile" __designer:bind="{ddwrt:DataBind('i',concat('ff12',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Mobile')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription12" FieldName="Mobile" ControlMode="New"/>
						</td>
					</tr>
					<tr id="extension" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField13" ControlMode="New" FieldName="Extension" __designer:bind="{ddwrt:DataBind('i',concat('ff13',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Extension')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription13" FieldName="Extension" ControlMode="New"/>
						</td>
					</tr>
					<tr id="email" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField14" ControlMode="New" FieldName="Email" __designer:bind="{ddwrt:DataBind('i',concat('ff14',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Email')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription14" FieldName="Email" ControlMode="New"/>
						</td>
					</tr>
					<tr id="title" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField15" ControlMode="New" FieldName="Title" __designer:bind="{ddwrt:DataBind('i',concat('ff15',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Title')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription15" FieldName="Title" ControlMode="New"/>
						</td>
					</tr>
					<tr id="location" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField16" ControlMode="New" FieldName="Location" __designer:bind="{ddwrt:DataBind('i',concat('ff16',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Location')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription16" FieldName="Location" ControlMode="New"/>
						</td>
					</tr>
					<tr id="googlemap" class="hidden">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField17" ControlMode="New" FieldName="GoogleMapLink" __designer:bind="{ddwrt:DataBind('i',concat('ff17',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@GoogleMapLink')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription17" FieldName="GoogleMapLink" ControlMode="New"/>
						</td>
					</tr>
					<!--<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="ff18{$Pos}" ControlMode="New" FieldName="sygt" __designer:bind="{ddwrt:DataBind('i',concat('ff18',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@sygt')}"/>
							<SharePoint:FieldDescription runat="server" id="ff18description{$Pos}" FieldName="sygt" ControlMode="New"/>
						</td>
					</tr>
